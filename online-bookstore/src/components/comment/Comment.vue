            ...
            <div class='content'>
              ...
              <div class='cart-content' v-for="pitem in order.products" :key="pitem.isbn">
                <div style="display:flex;flex-direction:row;justify-content:space-around;align-items:center;">
                      ...
                      <div class="comment">
                    <div class='score' style="width:80%;margin-right:5%;">
                    <span >评分：</span>
                      <a-rate :defaultValue="0" v-model="pitem.score" allowHalf />
                    </div>
              ...
              <br/>
               <a-button type='primary' style="width:30%;" @click="postComment()">提交评价</a-button>
              </div>
            </div>
          </a-layout-content>
        </a-layout>
