        ...
        <a-layout>
          <a-layout-content class='content'>
            ...
            <div class='revContent'>
              <div class='first'>
                ...
                <a-radio-group v-model="value"
                               ...
                               :key="item.addressId">
                  <a-radio-button :value='item.addressId'
                                  style="font-weight:bold;margin:2%;">{{item.name}}</a-radio-button>
            ...
            <div class='footer'>
              ...
              <div class='ensure'
                   style="background-color:white;border-bottom: 1px solid #cdcdcd;">
                <span>
                  <span>应付总额：</span>
            ...
            <a-button type="primary"
                      @click='submit'
                      style="width:10%;margin:2% 0 2% 80%;">提交订单</a-button>
